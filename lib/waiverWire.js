...
export async function getWaiverRecommendations(league) {
  ...
  // Genuinely common in a deep league: everyone this week's national
  // buzz is naming is already rostered here.
  if (!recommendations.length) {
    return { recommendations, note: "This week's trending pickups are already rostered in your league." };
  }
